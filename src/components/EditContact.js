      ...
      <Row >
        <Col xs={12} md={6} className="offset-md-3">
          <Card bg='secondary' className="contact-form-card">
            ...
            <Card.Img className="contact-form-pic" variant="top" src={imageUrl || "https://imgs.search.brave.com/2_9LHnzOqX-g1bLpnM1-0z4QWC5rajF6DGy1W-bWjvw/rs:fit:416:416:1/g:"} />
            <Card.Body>
              <Form>
                <Form.Group m={3}>
                  <Form.Control m={3} value={name} onChange={(e) => { setName(e.target.value) }} type="text" placeholder="Name" />
                </Form.Group>
                <Form.Group>
